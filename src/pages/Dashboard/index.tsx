        ...
        <div className="flex justify-end items-center">
          <div className="flex  items-center space-x-4 w-xl">
            ...
            <div className="flex items-center space-x-4 w-full">
              <p className="text-kidemia-black text-sm font-semibold">Category:</p>
              <Select className="w-full" size="sm" radius="sm" variant="underlined" color="warning" defaultSelectedKeys={["ce"]}>
                {categories.map((cat) => (
