...
export default function DeletePermModal({
  isOpen,
  onClose,
  onOpenChange,
  permission_id,
  ...
  const deletePermMutation = useMutation({
    mutationFn: (permission_id: string) =>
      ApiSDK.PermissionsService.deletePermissionApiV1PermissionsPermissionIdDelete(
        permission_id,
      ),
    onSuccess(data) {
      onClose();
          ...
          <div className="flex flex-col p-4 space-y-8">
            ...
            <div className="space-y-4 text-center">
              <h3 className="text-xl font-semibold text-kidemia-primary">
                Are you sure you want to delete this {name} Permission
              </h3>
              <p className="text-sm  text-kidemia-grey">
                Deleting this permission will revoke your access to the
                permission and remove all traces of it from Kidemia database.
              </p>
            </div>
          </div>
        </ModalBody>
        ...
        <ModalFooter>
          <div className="flex gap-3 w-full">
            <Button
              ...
              isDisabled={deletePermMutation.isPending}
            >
              Cancel
            </Button>
            <Button
              ...
              onPress={() => {
                deletePermMutation.mutate(permission_id);
              }}
